...
function UUIDtoList(uuidFormOt);
...
function App() {
  function onButtonClick() {
    ...
    navigator.bluetooth.requestDevice({
     // filters: [...] <- Prefer filters to save energy & show relevant devices.
        ...
        optionalServices: ['OHIOH-UUID']},
        optionalServices: ['dBm']
        )
    .then(device => {
    ...
    .then(server => {
      ...
      uuidFromOtherUser = server.getCharacteristic('OHIOH-UUID');
  ...
  return (
    <div className="App">
        ...
        <button onClick={onButtonClick}>Connect to a Bluetooth device</button>
